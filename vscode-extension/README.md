...
<p align="center">
  <a href="https://pypi.org/project/costopt/"><img src="https://img.shields.io/badge/pypi-v0.2.14-blue?style=flat-square" alt="PyPI"></a>
  ...
  <a href="https://open-vsx.org/extension/khusshdesai/costopt-vscode"><img src="https://img.shields.io/badge/Open%20VSX-5K%2B%20installs-purple?style=flat-square" alt="Open VSX"></a>
  <a href="https://marketplace.visualstudio.com/items?itemName=khusshdesai.costopt-vscode"><img src="https://img.shields.io/badge/VS%20Marketplace-v0.2.14-blue?style=flat-square" alt="VS Marketplace"></a>
</p>
...
> **Prerequisites:** This extension requires the CostOpt Python package. Install it first:
> ```bash
> pip install costopt
> ```
> Then run `costopt dashboard --port 8400` to start the local server before using extension features.
